...
import EclassthreeImg from "./productsImg/E (class) Three Phase , 415 V, 50 Hz, Induction Motors.jpg";
import { useEffect } from "react";

function Eclassthree() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);

    const tableData = [
        { model: "KM-01", hp: "0.50", kw: "0.37", phase: "3", framesize: "71 M", shaftdia: "16 mm", rpm: "1440" },
            ...
            <table className="table-auto w-full bg-white border border-gray-300 shadow-md">
                <thead>
                    <tr className="bg-gray-700 text-white">
                        ...
                        <th className="py-2 px-4 border-b text-left">Shaft Diameter (mm)</th>
            ...
            <div className="mx-auto px-4 flex flex-col lg:flex-row items-start lg:items-center gap-4 py-6 bg-gray-50">
                <div className="lg:w-[35vw] w-full flex justify-center lg:justify-start">
                    <img
                        ...
                        alt="E-Class Induction Motors"
                    />
                </div>

                <div className="lg:w-1/2 w-full">
                    <h2 className="text-4xl font-bold mb-6 text-gray-800">
                        E (Class) Three Phase, 415 V, 50 Hz, Induction Motors
                    </h2>
