...
function BenchGrinder2BearingThree() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);

    const tableData = [
        { model: "KP-01", hp: "2", kw: "1.5", phase: "3", rpm: "2800", remarks: "Light" },
        { model: "KP-02", hp: "2", kw: "1.5", phase: "3", rpm: "2800", remarks: "Heavy" },
        { model: "KP-03", hp: "3", kw: "2.2", phase: "3", rpm: "2800", remarks: "Heavy" },
        { model: "KP-04", hp: "5", kw: "3.7", phase: "3", rpm: "2800", remarks: "Heavy" },
        { model: "KP-05", hp: "7.5", kw: "5.5", phase: "3", rpm: "2800", remarks: "Heavy" },
    ];
        ...
        <div>
            ...
            <div className="mx-auto px-4 flex flex-col lg:flex-row items-start lg:items-center gap-4 py-6 bg-gray-50">
                <div className="lg:w-[35vw] w-full flex justify-center lg:justify-start">
                    <img
                        src={BenchGrinder2BearingSingleImg}
                        className="w-full sm:w-2/3 lg:w-3/4 xl:w-2/3 lg:ml-32 border-2"
                        alt="Bench Grinder Two Bearing Three Phase" // Updated alt text
                    />
                </div>

                <div className="lg:w-1/2 w-full">
                    <h2 className="text-4xl font-bold mb-6 text-gray-800">
                        BENCH GRINDER TWO BEARING THREE Phase {/* Updated heading */}
                    </h2>
...
export default BenchGrinder2BearingThree;
