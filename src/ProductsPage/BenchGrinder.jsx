...
import BenchGrinderImg from "./productsImg/BENCH GRINDERS (FOUR BEARINGS) THREE PHASE.jpg";
...
function BenchGrinder() {
  ...
  const tableData = [
    { model: "KGF-01", hp: "2", kw: "1.5", phase: "3", rpm: "2800", wheelSize: "12”X1.5”&2”", remarks: "Heavy" },
    { model: "KGF-02", hp: "3", kw: "2.2", phase: "3", rpm: "2800", wheelSize: "12”X1.5”&2”", remarks: "Light" },
    { model: "KGF-03", hp: "3", kw: "2.2", phase: "3", rpm: "2800", wheelSize: "12”X1.5”&2”", remarks: "Heavy" },
    { model: "KGF-04", hp: "5", kw: "3.7", phase: "3", rpm: "2800", wheelSize: "12”X1.5”&2”", remarks: "Heavy" },
    { model: "KGF-05", hp: "7.5", kw: "5.5", phase: "3", rpm: "2800", wheelSize: "12”X1.5”&2”", remarks: "Heavy" },
  ];
      ...
      <div className="mx-auto px-4 flex flex-col lg:flex-row items-start lg:items-center gap-4 py-6 bg-gray-50">
        ...
        <div className="lg:w-1/2 w-full">
          <h2 className="text-4xl font-bold mb-6 text-gray-800">
            BENCH GRINDERS (FOUR BEARINGS) THREE PHASE
          </h2>
          {renderTable(tableData)} {/* Render the table here */}
        </div>
      </div>
      <ContactCopy />
    </div>
